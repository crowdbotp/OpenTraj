...
| ![](DUT/reference.png) | [DUT](https://github.com/amiryanj/OpenTraj/blob/master/DUT) | Natural Vehicle-Crowd Interactions in crowded university campus <code>#Traj:[Peds=1,739 vehicles=123 Total=1,862]</code> <code>Coord=world-2D</code> <code>FPS=23.98</code> | [github](https://github.com/dongfang-steven-yang/vci-dataset-citr) [paper](https://arxiv.org/pdf/1902.00487.pdf) | 
| ![](CITR/reference.png) | [CITR](https://github.com/amiryanj/OpenTraj/blob/master/CITR) | Fundamental Vehicle-Crowd Interaction scenarios in controlled experiments <code>#Traj:[Peds=340]</code> <code>Coord=world-2D</code> <code>FPS=29.97</code> | [github](https://github.com/dongfang-steven-yang/vci-dataset-dut) [paper](https://arxiv.org/pdf/1902.00487.pdf) | 
| ![](Ko-PER/reference.png) | [Ko-PER](https://github.com/amiryanj/OpenTraj/blob/master/Ko-PER) | Trajectories of People and vehicles at Urban Intersections (Laserscanner + Video) <code>#Traj:[peds=350]</code> <code>Coord=world-2D</code> | [paper](https://www.uni-ulm.de/fileadmin/website_uni_ulm/iui.inst.110/Bilder/Forschung/Datensaetze/20141010_DatasetDocumentation.pdf) | 
...
| ![](ETH-Person/reference.png) | [ETH-Person](https://github.com/amiryanj/OpenTraj/blob/master/ETH-Person) |  | [website](https://data.vision.ee.ethz.ch/cvl/aess/) | 
